...
python /home/henrye/downloads/Henry_OpenNMT-py/train.py \
	-data preprocess/original_order/original_order_surface_realization \
	-save_model train/original_order/original_order_surface_realization \
	--log_file train/original_order/log.txt \
	--optim adam \
	--learning_rate 0.001 \
	--encoder_type brnn \
	--layers 1 \
